...
public class BlockLootProvider extends BlockLootProviderBase {
    ...
    protected void setup() {
        ...
        this.drops(ModBlocks.dreamwoodLeaves, this.first(
                this.element().with(this.or(this.silkCondition(), this.matchTool(Items.SHEARS))),
                this.combine(
                        this.stack(BotaniaItems.DREAMWOOD_TWIG).with(this.randomFortune(0.06f)).with(this.count(1, 2)),
